...
extern "C" {
    ...
    #[doc = " target variable is specified by \\a v, which should be a value returned by"]
...
extern "C" {
    ...
    #[doc = " array. The target variable is specified by \\a v."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " <B>Description</B>"]
    #[doc = ""]
    #[doc = " @ref rtContextValidate checks the given context and all of its associated OptiX"]
...
extern "C" {
    ...
    #[doc = " <B>Description</B>"]
    #[doc = ""]
    #[doc = " @ref rtGeometryInstanceValidate checks \\a geometryinstance for completeness. If \\a geometryinstance or"]
...
extern "C" {
    ...
    #[doc = " Therefore, the flags are set per material slot (with the actual material binding being set on the GeometryInstance)."]
...
extern "C" {
    ...
    #[doc = " element size is set to \\a elementSize and all storage associated with the buffer is reset."]
    ...
    #[doc = " buffer has format @ref RT_FORMAT_USER but \\a elementSize is 0."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " \\a list. The command list must have been created from the same context as the post-processing"]
    #[doc = " stage."]
